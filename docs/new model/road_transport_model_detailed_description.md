...
Module 1 defaults are the primary upstream source for base-year road assumptions in the current workflow. These are generated into `input_data/module1_defaults/` and loaded by `codebase/road_workflow.py` before Modules 2 to 6 run.
