...
SCHEMAS: dict[str, dict] = {
    ...
    "T5_stock_targets": {
        ...
        "columns": {
            ...
            "k_used":                 _col("float", False, "Deprecated passenger S-curve steepness parameter"),
            "passenger_income_elasticity_used": _col("float", False, "GDP-per-capita income elasticity applied (passenger only)"),
            "passenger_raw_income_elasticity": _col("float", False, "Unclipped passenger income elasticity estimate"),
            "passenger_income_elasticity_clamped": _col("bool", False, "True if passenger income elasticity was clamped to bounds"),
            "passenger_energy_growth_rate": _col("float", False, "Annualised passenger energy growth rate used for elasticity"),
            "passenger_gdp_per_capita_growth_rate": _col("float", False, "Annualised GDP-per-capita growth rate used for passenger elasticity"),
            "passenger_income_elasticity_data_source": _col("str", False, "estimated | estimated_adjusted | default | saturated"),
            "passenger_income_elasticity_note": _col("str", False, "Passenger income elasticity diagnostic note"),
